...
const en = {
    ...
    plans: [
      {
        name: "Starter",
        price: "From $1,499",
        d: "For MVPs and early product validation.",
        features: ["Single platform app", "Up to 5 screens", "Firebase backend", "1 month support"],
      },
      {
        name: "Professional",
        price: "From $3,999",
        d: "For growing businesses ready to scale.",
        features: ["iOS + Android", "Up to 15 screens", "Admin dashboard", "Payment integration", "3 months support"],
      },
      {
        name: "Enterprise",
        price: "Custom",
  ...
  faq: {
    ...
    items: [
      ...
      { q: "How much does a mobile app cost?", a: "Projects start from $1,499. Final pricing depends on features, platforms and integrations." },
...
const ar: Dict = {
  ...
  hero: {
    ...
    title: "ابنِ تطبيق موبايل بثقة كاملة",
    subtitle:
    ...
    plans: [
      {
        name: "المبتدئ",
        price: "يبدأ من 1,499$",
        d: "مثالي للنماذج الأولية وإطلاق فكرتك.",
        features: ["منصة واحدة", "حتى 5 شاشات", "Firebase Backend", "دعم لمدة شهر"],
      },
      {
        name: "الاحترافي",
        price: "يبدأ من 3,999$",
        d: "للشركات الجاهزة للنمو والتوسع.",
        features: ["iOS و Android", "حتى 15 شاشة", "لوحة تحكم إدارية", "تكامل مدفوعات", "دعم 3 أشهر"],
      },
      {
        name: "المؤسسي",
        price: "حسب الطلب",
  ...
  faq: {
    ...
    items: [
      ...
      { q: "ما تكلفة تطبيق الموبايل؟", a: "المشاريع تبدأ من 1,499$. السعر النهائي يعتمد على المزايا والمنصات والتكاملات." },
...
export function I18nProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    try {
      const storedLang = (localStorage.getItem("lang") as Lang | null) ?? "ar";
...
export const CONTACT_EMAIL = "hello@appmakeregypt.com";
